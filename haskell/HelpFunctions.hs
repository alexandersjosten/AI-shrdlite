...
--2 Add object to the top of stack i and return the new world
        ...
        where
          ...
          fstItemid = case stack of 
                      ...
                      b  -> do
                            ...
                            if (okMove obj1  obj2) then Primative "ERROR" "ERROR" else (Primative id oldId) --Check if illegal move is about to be made
